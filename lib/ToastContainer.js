  ...
  render() {
    ...
    return props.mask ?
        <View style={ styles.maskStyle }>
          <View
              style={ [styles.maskStyle, props.maskColor && { backgroundColor: props.maskColor }, props.maskOpacity && { opacity: props.maskOpacity }] }></View>
          { this.props.children }
        </View> :
        this.props.children
